 ...
 *
 * @ORM\Table(name="artykuly_cechy_powiazania", indexes={@ORM\Index(name="id_artykulu", columns={"id_artykulu"}), @ORM\Index(name="id_pozycji_slownika", columns={"id_pozycji_slownika"})})
 * @ORM\Entity
 */
